...
class ConfigManager:
    ...
    # 配置项验证规则
    VALIDATION_RULES = {
        'google_drive.folder_id': {'type': str},
        'google_drive.api_key': {'type': str},
        'google_drive.api_call_interval': {'type': int, 'min': 60, 'max': 86400},
        'google_drive.credentials_path': {'type': str},
        'google_drive.token_path': {'type': str},
        'local_monitor.mount_point': {'type': str},
        'local_monitor.polling_interval': {'type': int, 'min': 30, 'max': 3600},
        'local_monitor.watch_patterns': {'type': list},
        'local_monitor.ignore_patterns': {'type': list},
        'symlink.target_base': {'type': str},
        'symlink.video_extensions': {'type': list},
        'emby.server_url': {'type': str},
        'emby.api_key': {'type': str},
        'database.path': {'type': str},
        'database.backup_count': {'type': int, 'min': 1, 'max': 100},
        'logging.path': {'type': str},
    ...
    ENV_MAPPING = {
        ...
        'GOOGLE_DRIVE_POLL_INTERVAL': 'google_drive.api_call_interval',
        'MOUNT_POINT': 'local_monitor.mount_point',
        'LOCAL_POLL_INTERVAL': 'local_monitor.polling_interval',
